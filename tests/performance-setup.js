// Performance Test Setup for Harmony Music Platform
...
global.performanceMonitor = {
  ...
  endTime: null,
  start: () => {
    global.performanceMonitor.startTime = process.hrtime.bigint();
  },
  end: () => {
    global.performanceMonitor.endTime = process.hrtime.bigint();
    const duration = Number(global.performanceMonitor.endTime - global.performanceMonitor.startTime) / 1000000; // Convert to milliseconds
    return duration;
  },
  measure: (label) => {
